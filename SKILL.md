---
name: hermes-skill-understand-chat
description: Ask targeted questions about a codebase using its knowledge graph rather than guessing from filenames. Use when the user explicitly requests this capability or a closely related task.
---
